...
theme.bg_normal     = color["greengrey"]-- default: greyblack, using darkgrey
theme.bg_focus      = color["green"] --default: lightgrey
theme.bg_urgent     = color["darkgreen"]
theme.bg_minimize   = color["greengrey"] --
...
theme.border_marked = color["darkgreen"]

theme.titlebar_bg_focus = color["green"] 
...
theme.awesome_icon       = theme_path .. "assets/manjaro_logo_circle.png"
